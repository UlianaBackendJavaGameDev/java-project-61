...
[![hexlet-check](https://github.com/UlianaBackendJavaGameDev/java-project-61/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/UlianaBackendJavaGameDev/java-project-61/actions)
...
```bash
git clone https://github.com/UlianaBackendJavaGameDev/java-project-61.git
cd java-project-61
```
